...
<mc-modal :title="title" classes="create-modal" @open="reset()">
    <template #default>
        <div class="create-modal__fields">
            <div v-if="!entity" class="field">
                <label><?php i::_e('Nome do Ente Federado') ?></label>
                <input type="text" v-model="name">
                <p class="field__note"><?php i::_e('O CNPJ não é digitado: vem da própria Plataforma CultBR ao verificar o token.') ?></p>
            </div>
            ...
            <div class="field">
                <label v-if="entity"><?php i::_e('Novo token') ?></label>
                <label v-else><?php i::_e('Token do CultBR') ?></label>
                <input type="password" v-model="token" autocomplete="off">
                <p v-if="entity" class="field__note"><?php i::_e('Deixe em branco para manter o token atual.') ?></p>
            </div>
        </div>
    </template>
