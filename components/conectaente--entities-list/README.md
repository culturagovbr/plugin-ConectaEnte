...
As abas seguem o `panel--entity-tabs` do core (`mc-tabs` com `sync-hash`, ícone de lixeira no cabeçalho da aba). A busca só age na aba de ativos. As poucas regras próprias de alinhamento do card ficam em `assets-src/sass/conectaente.scss`, compilado pelo mix.
